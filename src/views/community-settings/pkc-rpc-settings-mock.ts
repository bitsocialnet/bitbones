  ...
  challengeExcludes: {
    role: {
      optionInputs: [
        { option: 'roles', label: 'Roles', default: '', description: 'Comma separated list of roles.', placeholder: 'admin,moderator,etc...' },
        {
          ...
          placeholder: 'reply,post,vote,commentEdit,commentModeration,communityEdit,etc...',
        },
      ],
    ...
    'age-and-score': {
      optionInputs: [
        ...
        {
          option: 'postMultiplier',
          label: 'Post multiplier',
          default: '1',
          description: 'Multiply daysOld and score if publication is a post, e.g. 2.',
          placeholder: '1',
        },
        {
  ...
  challengeRateLimiters: {
    ...
    'per-hour': {
      optionInputs: [
        ...
        { option: 'communityEditsPerHour', label: 'Community edits per hour.', default: '5', description: 'Community edits per hour.', placeholder: '5' },
      ],
