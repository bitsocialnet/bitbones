import './log.js';
import { app, BrowserWindow, Menu, MenuItem, Tray, screen as electronScreen, shell, dialog, ipcMain } from 'electron';
...
// send pkc rpc auth key to renderer
const pkcDataPath = !isDev ? EnvPaths('pkc', { suffix: false }).data : path.join(dirname, '..', '.pkc');
...
const realUserAgent = `bitbones/${packageJson.version}`;
...
const createMainWindow = () => {
  ...
  // do not open links in bitbones or will lead to remote execution
