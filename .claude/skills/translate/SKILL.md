---
name: translate
description: Add, update, or remove bitbones i18next translations when locale changes are requested.
---

<!-- Generated from .agents/skills/translate/SKILL.md; run yarn ai-workflow:sync. -->
...
Keep product naming lowercase `bitbones`; preserve the Bitsocial/PKC/community naming rules in AGENTS.md.
