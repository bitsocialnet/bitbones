...
description: Map a visible bitbones DOM node to its React source when file or component attribution is needed.
---
...
```bash
./scripts/pw-session.sh open inspect http://localhost:5173/#/
